...
export default function Home() {
  ...
  const stats = [
    ...
    { value: 20, label: t("statistic2") },
    { value: 120, label: t("statistic3") },
    ...
    <main>
      ...
      <section className="relative top-0">
          ...
          <div className="absolute w-full inset-0 flex items-center">
            <div className=" max-w-7xl mx-auto ml-auto px-4 md:px-8">
              <div className="max-w-2xl">
                {/* Title: 80px on desktop, responsive downwards */}
       ...
       <section className="bg-[#EEF3FF] pb-10" >
        ...
        <Link href="/aboutus" className="mt-6 inline-flex items-center gap-2 font-semibold text-[#143C99] hover:opacity-80" > {t("more")} 
         <svg
              viewBox="0 0 24 24"
              className="h-4 w-4"
              fill="none"
        ...
        <div className="mt-6  sm:mt-8">
          <Image
            src="/homephoto/about.png"     // replace with your image
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 md:gap-y-12">
          {stats.map((it, i) => (
            <div key={i} className="relative text-center">
              {/* thin top line (like in the design) */}
